...
export default function CTASection({ locale, dict }: { locale: Locale; dict: Dictionary }) {
  return (
    <section className="container-x">
      <Reveal className="relative overflow-hidden rounded-4xl bg-navy-800 px-6 py-16 sm:px-14 sm:py-20">
        ...
        <div className="relative mx-auto max-w-2xl text-center">
          <h2 className="text-balance font-display text-3xl font-extrabold leading-tight text-white sm:text-4xl">
            {dict.ctaBanner.title}
          </h2>
          <p className="mt-4 text-base leading-relaxed text-navy-100 sm:text-lg">{dict.ctaBanner.subtitle}</p>
